...
const InspectorSidebar = ({ activeSection, setActiveSection }) => {
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: BarChart3 },
    { id: 'my-account', label: 'My Account', icon: Settings }, // ✅ Fixed: was 'myaccount'
    { id: 'bid-room', label: 'Bidding Room', icon: Gavel }, // ✅ Fixed: was 'bidroom'
    { id: 'analytics', label: 'Detail Analysis', icon: BarChart3 },
    { id: 'bid-history', label: 'Bid History', icon: History }, // ✅ Fixed: was 'bidhistory'
    { id: 'payments', label: 'Payments', icon: CreditCard },
    { id: 'inspection-room', label: 'Inspection Room', icon: ClipboardCheck }, // ✅ Fixed: was 'inspectionroom'
    { id: 'chat', label: 'Chat with Us', icon: MessageCircle }, // ✅ Fixed: was 'chatwithus'
  ];
